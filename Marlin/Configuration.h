...
#define STRING_CONFIG_H_AUTHOR "Lorem" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lorem's Tarantula"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 177.62
  #define DEFAULT_bedKi 31.89
  #define DEFAULT_bedKd 247.36
...
#define Z_SERVO_ANGLES { 14, 105 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 92, -10 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 15, 20, 20, 15 } // (mm) Left, Front, Right, Back insets
